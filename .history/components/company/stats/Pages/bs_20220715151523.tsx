  ...
  return (
    <div>
      ...
      <div className={styles.graph} style={{ marginTop: "-3em" }}>
        <Image src={graph} width="390px" height="320px" />
      </div>

      <div className={styles.valuation_text}>
        <p style={{ marginBottom: "0.5em" }}>
          <span className={styles.symbol_r}>✕</span>{" "}
          <span className={styles.ratio_type_r}>Liquidity: </span> low liquity,
          high proportion of debt.
        </p>
        <p style={{ marginBottom: "0.5em" }}>
          <span className={styles.symbol_r}>✕</span>{" "}
          <span className={styles.ratio_type_r}>Short Term Liabilities </span>{" "}
          high short term liabilities.
        </p>
        <p style={{ marginBottom: "0.5em" }}>
          <span className={styles.symbol_r}>✕</span>{" "}
          <span className={styles.ratio_type_r}>Debt Coverage:</span> high debt
          coverage.
        </p>
      </div>
