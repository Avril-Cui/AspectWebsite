    ...
    <div>
      ...
      <div>
        <table className={styles.stats_data_table}>
          ...
          <tr>
            <td className={styles.data_type_bs}>Non-Current Assets</td>
            <td className={styles.data_bs}>8.2 B</td>
          </tr>
          <tr>
            <td className={styles.data_type}>Total Liabil_bsities</td>
          ...
          <tr>
            <td className={styles.data_type_bs}>Non-Current Liabilities</td>
            <td className={styles.data_bs}>1.5 B</td>
          </tr>
          <tr>
