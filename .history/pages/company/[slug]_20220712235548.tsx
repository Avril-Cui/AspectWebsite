import WrknChart from "../../components/company/charts/wrknChart";
import styles from "../../styles/simulator/company.module.css";
import stock_valuation from "/Users/xiaokeai/Desktop/articleBackend-main/image/snowflask_chart/demo_chart.png"
...
// import ChatBox from "../../components/company/chat/chatBox"
    ...
    <div className={styles.container}>
      <div key={individual.id}>
          ...
          <div className={styles.trade_container}>
            ...
            <div>
              ...
              <div className={styles.trade_input}>
                ...
                <div className={styles.trade_place} style={{marginLeft: 70}}/>
              </div>
              <div className={styles.trade_input}>
                <p className={styles.trade_text}>Price</p>
                <div className={styles.trade_place} style={{marginLeft: 75}}/>
              </div>
            </div>
          ...
          <div className={styles.comp_overview}>
            <div className={styles.dimension_container}>
              ...
              <div style={{marginLeft: "0.5em"}}>
                <p className={styles.multi_dimension}>Multi-Dimension Check</p>
                <p className={styles.multi_dimension_description}>Analyzing stocks from multiple aspects to get a well-rounded snapshot.</p>
              </div>
            </div>
            <div className={styles.overview_content}>
              ...
              <Link href="/company_profile"><p className={styles.company_profile_link}>About this company</p></Link>
              <div style={{marginTop: "0.5em", marginLeft: "1.25em"}}>
                <div style={{marginBottom: "1em"}}>
                  <p className={styles.overview_type}>OPPORTUNITIES</p>
                  <p className={styles.overview_specific_content}><span className={styles.star}>&#9733;</span> Earnings are forecast to grow 24.56% per year.</p>
                  <p className={styles.overview_specific_content}><span className={styles.star}>&#9733;</span> Earnings grew by 125.45% over the past year.</p>
                </div>
                <div>
                  <p className={styles.overview_type}>RISKS</p>
                  <p className={styles.overview_specific_content}><span className={styles.warning_symbol}>&#9888;</span> Significant insider selling over the past 3 month.</p>
                  <p className={styles.overview_specific_content}><span className={styles.warning_symbol}>&#9888;</span> Shareholders have been diluted in the past year.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.lorem}>
          ...
          reiciendis sequi earum quos optio debitis! Quae, quo earum, dolor
          minima nihil deserunt consequatur repellat accusamus modi voluptas
          maiores. Placeat, ratione. Exercitationem sit molestiae officia nemo
          explicabo, eum, qui quam aliquam non commodi hic, dolor unde libero
          repellendus neque in labore possimus. Consequatur eos harum fugiat rem
          natus voluptas voluptate amet! Velit exercitationem atque sint
          inventore ex cum fugit rerum, ullam veniam alias eos aliquam,
          accusamus omnis? Natus aliquam id, ullam asperiores, ea nam amet eaque
          assumenda praesentium, aliquid maxime accusantium?
        </div>
        ...
        <div className={styles.chat_box}>
          <p className={styles.title_text}>Chat Box</p>
          {/* <ChatBox /> */}
        </div>
